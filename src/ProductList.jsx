...
function ProductList({ onHomeClick }) {
   ...
   const plantsItem=useSelector((state) => state.CartItem);
            ...
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                        ...
                        <h3 style={{position:"sticky", fontSize:"28px", height:"45px", width:"55px", right:"62px",top:"18px", textAlign:"center"}}>{sepetSayisi()}</h3></h1></a></div>
                </div>
            </div>
            {!showCart ? (
